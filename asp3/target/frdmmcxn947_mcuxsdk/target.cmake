...
#
#  MCX N の LPUART は LP_FLEXCOMM 上に載るため，スタンドアロンの
#  core/drivers/lpuart ではなく core/drivers/lpflexcomm/lpuart を使う
#  （features の FSL_FEATURE_LPUART_IS_LPFLEXCOMM=1）．
#
list(APPEND ASP3_INCLUDE_DIRS
    ...
    ${MCUX_SDK_DIR}/devices-mcx/MCXN/periph
    ${MCUX_SDK_DIR}/core/drivers/common
    ${MCUX_SDK_DIR}/core/drivers/lpflexcomm
    ${MCUX_SDK_DIR}/core/drivers/lpflexcomm/lpuart
    ${MCUX_SDK_DIR}/core/drivers/ctimer
    #  board.h が fsl_gpio.h / fsl_port.h を取り込むため（LPUART ピン定義）
    ${MCUX_SDK_DIR}/core/drivers/gpio
    ${MCUX_SDK_DIR}/core/drivers/port
    ${TARGETDIR}
)
...
list(APPEND ASP3_COMPILE_OPTIONS
    ...
    -mfpu=fpv5-sp-d16
    -mfloat-abi=hard
    #  Secure 実行（SDK startup＝Secure ブート）に合わせ TrustZone を有効化．
    #  MCXN947 の CMSIS デバイスヘッダは __ARM_FEATURE_CMSE 有効時に
    #  ペリフェラルの Secure エイリアス（0x5000_xxxx）を選ぶ．未指定だと
    #  Non-secure エイリアス（0x4000_xxxx）になり，Secure CPU から CTIMER 等の
    #  クロックゲート対象ペリフェラルへアクセスするとバスストールする（実機確認）．
    -mcmse
    -ffunction-sections
    -fdata-sections
)
